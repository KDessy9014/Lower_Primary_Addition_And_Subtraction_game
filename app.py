...
<li>Solve Addition and Subtraction up to 50.</li>
<li>Each correct answer is worth 2 points.</li>
<li>Mistakes freeze your keypad for 3 seconds!</li>
<li>The game lasts for 30 rounds.</li>
</ul>
...
function nextQ(){
    ...
    let a = Math.floor(Math.random() * 51); // 0 to 50
    let b = Math.floor(Math.random() * 51); // 0 to 50
